...
class VisionLinkApp(ctk.CTk):
    def __init__(self):
        ...
        # [NEW: Phase 2] - Background Worker Variables & Thread setup
    ...
    # [NEW: Phase 2] - Background Thread for AI Processing
    def camera_worker(self):
        while True:
            try:
                ...
                time.sleep(0.01) # Allow PC to breathe
    ...
    def start_camera_feed(self):
        ...
        # [NEW: Phase 2] - Get frame instantly from background worker without waiting
        ...
        # UI and Voice Automation Logic (Runs independently of video lag)
